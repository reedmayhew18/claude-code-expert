...
## Document Formats
*Asked about specifically during project setup — these are production-grade file creation/editing skills from Anthropic.*
...
| `pptx` | Create and edit PowerPoint presentations with themes, QA workflow, and design guidelines |
...
| Skill | Description |
|-------|-------------|
| `brainstorm` | Structured ideation using divergent/convergent thinking frameworks (bisociation, SCAMPER, role-storming) |
...
| `project-optimizer` | Deep scan of project structure, CLAUDE.md, skills, agents, and workflows with prioritized improvement report |
...
| Skill | Description |
|-------|-------------|
| `pytorch-training-loop` | Complete PyTorch training loop: DataLoader, optimizer, scheduler, mixed precision, checkpointing, logging |
| `torch-optimize` | Profile and fix slow/OOM PyTorch: mixed precision, `torch.compile`, DataLoader tuning, gradient checkpointing |
